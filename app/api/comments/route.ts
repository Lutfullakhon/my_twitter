...
export async function PUT(req: Request) {
	try {
		...
		const comment = await Comment.findByIdAndUpdate(commentId, {$push: {likes: currentUser._id}, 
		})
...
export async function DELETE(req: Request) {
	try {
		...
		await Comment.findByIdAndUpdate(commentId, {$pull: {likes: currentUser._id}, 
		})
