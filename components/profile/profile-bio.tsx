	...
	return (
		<>
				...
				<div className='mt-8 px-4'>
					...
					<div className='flex flex-col mt-4'>
						...
						<div className='flex gap-4 items-center'>
							...
							<div className='flex flex-row items-center gap-2 mt-4 to-neutral-500 '>
								<BiCalendar size={24} />
								<p>
			...
			<Modal
				...
				body={
					<>
						<div className='flex flex-row w-full py-3 px-4 gap-2'>
							<div
								className={cn(
									'w-[50%] h-full justify-center items-center cursor-pointer font-semibold',
									state === 'following' && 'border-b-[2px] border-sky-500 '
								)}
								onClick={onFollowing}
							>
								Following
							...
							<div
								className={cn(
									'w-[50%] h-full justify-center items-center cursor-pointer font-semibold',
									state === 'followers' && 'border-b-[2px] border-sky-500 '
								)}
								onClick={onFollowers}
							>
								Followers
