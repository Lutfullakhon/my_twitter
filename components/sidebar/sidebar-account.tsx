...
const SidebarAccount = ({ user }: Props) => {
	return (
		<>
			...
			<Popover>
				<PopoverTrigger className='w-full rounded-full hover:bg-slate-300/10 hidden lg:block cursor-pointer px-4 py-2 transition'>
				...
				<PopoverContent className='bg-black border-none rounded-2xl shadow shadow-white px-0 mb-3'>
					<div
						className='font-bold text-white cursor-pointer hover:bg-slate-300/10 p-4 transition'
						onClick={() => signOut()}
					>
